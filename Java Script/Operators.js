...
console.log("The value of num1 * num2 is "+ (num1 * num2));
console.log("The value of num1 / num2 is "+ (num1 / num2));
console.log("The value of num2 % num1 is "+ (num2 % num1));       //It is for the remainder
console.log("The value of num1 ** num2 is "+ (num1 ** num2));     //num1^num2
console.log("The value of num1 ** 3 is " + (num1 ** 3));
